...
const stone: GatewayApi = {
  ...
  setBuiltInProxyCustomRules: (rules) => invokeBuiltInProxy('stone:set-built-in-proxy-custom-rules', rules),
  ...
  getRequestMonitorAlwaysOnTop: () => ipcRenderer.invoke('stone:get-request-monitor-always-on-top'),
  toggleRequestMonitorAlwaysOnTop: () => ipcRenderer.invoke('stone:toggle-request-monitor-always-on-top'),
  setRequestMonitorDragging: (active) => ipcRenderer.invoke('stone:set-request-monitor-dragging', active),
  ...
  getAutomaticBackupRuntimeState: () => ipcRenderer.invoke('stone:get-automatic-backup-runtime-state'),
  ...
  openProjectPage: (page) => ipcRenderer.invoke('stone:open-project-page', page),
