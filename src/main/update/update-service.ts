...
const PROJECT_PAGE_URLS: Readonly<Record<ProjectPage, string>> = Object.freeze({
  source: 'https://github.com/M4rkzzz/stone-plus',
  license: 'https://github.com/M4rkzzz/stone-plus/blob/main/LICENSE',
  notices: 'https://github.com/M4rkzzz/stone-plus/blob/main/THIRD_PARTY_NOTICES.md',
  trademarks: 'https://github.com/M4rkzzz/stone-plus/blob/main/TRADEMARKS.md'
})
...
export class UpdateService {
  ...
  public async openProjectPage(page: ProjectPage): Promise<void> {
    const url = PROJECT_PAGE_URLS[page]
    if (!url) throw new Error('Unknown StonePlus project page.')
    await this.options.openExternal(url)
  }
