...
- 使用讨论：[GitHub Discussions](https://github.com/M4rkzzz/stone-plus/discussions)
- 问题与建议：[GitHub Issues](https://github.com/M4rkzzz/stone-plus/issues)
- 安全问题：[Private Vulnerability Reporting](https://github.com/M4rkzzz/stone-plus/security/advisories/new)
- 中文 QQ 群：**1061282900**

分享日志或诊断结果前，请先阅读 [SECURITY.md](SECURITY.md) 并确认其中不含账号资料。
...
Stone+ 依据 [Apache License 2.0](LICENSE) 开源。版权与第三方许可见 [NOTICE](NOTICE) 和 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。

感谢 [Stone](https://github.com/EasyCode-Obsidian/Stone) 上游项目及所有贡献者。Stone+ 是社区独立维护的非官方增强版，与上游维护者及各模型厂商均无隶属或背书关系。
