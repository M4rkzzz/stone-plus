...
function legacyStateWithoutGrokBuild(): PersistedState {
  return {
    ...
    accounts: [{
      ...
      maxConcurrency: 2,
      inFlight: 0,
      modelAllowlist: ['legacy-upstream-model'],
      circuitState: 'closed',
    ...
    requestLogs: [],
    credentials: {
      'legacy-credential': Buffer.from('vault:legacy-codex-key', 'utf8').toString('base64'),
    },
    clientProfiles: [{
      id: 'default-codex',
