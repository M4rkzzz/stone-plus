...
// WHATWG Fetch rejects a small legacy list of ports before the request reaches
// the dispatcher. Windows can still hand one of those ports to listen(0),
// which made otherwise unrelated transport tests fail intermittently.
